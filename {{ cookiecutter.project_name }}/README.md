# Why? [![Build Status](https://travis-ci.org/{{ cookiecutter.git_username }}/{{ cookiecutter.project_name }}.svg?branch=master)](https://travis-ci.org/{{ cookiecutter.git_username }}/{{ cookiecutter.project_name }})
